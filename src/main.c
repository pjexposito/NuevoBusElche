...
static void menu_draw_row_callback(GContext* ctx, const Layer *cell_layer, MenuIndex *cell_index, void *data) {
  switch (cell_index->section) {
    ...
    case 1:
      switch (cell_index->row) {
        case 0:
          menu_cell_basic_draw(ctx, cell_layer, texto_favoritos(FAV1_PKEY), devuelve_datos_parada(devuelve_valor(FAV1_PKEY),0), NULL);
          break; 
        case 1:
          menu_cell_basic_draw(ctx, cell_layer, texto_favoritos(FAV2_PKEY), devuelve_datos_parada(devuelve_valor(FAV2_PKEY),0), NULL);
          break;
        case 2:
          menu_cell_basic_draw(ctx, cell_layer, texto_favoritos(FAV3_PKEY), devuelve_datos_parada(devuelve_valor(FAV3_PKEY),0), NULL);
          break;
        case 3:
          menu_cell_basic_draw(ctx, cell_layer, texto_favoritos(FAV4_PKEY), devuelve_datos_parada(devuelve_valor(FAV4_PKEY),0), NULL);
          break;  
        case 4:
          menu_cell_basic_draw(ctx, cell_layer, texto_favoritos(FAV5_PKEY), devuelve_datos_parada(devuelve_valor(FAV5_PKEY),0), NULL);
          break;
      }
  }
}
